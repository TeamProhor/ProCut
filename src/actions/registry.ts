...
// eslint-disable-next-line procut/prefer-object-params -- action registries read best as (action, handler).
...
// eslint-disable-next-line procut/prefer-object-params -- dispatchers conventionally separate action, payload, and trigger.
