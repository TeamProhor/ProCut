export const projectsTranslations = {
	...
	bn: {
		...
		emptyStates: {
			...
			noProjectsDescription: "আপনার প্রথম প্রজেক্ট তৈরি শুরু করুন। মিডিয়া ইম্পোর্ট করুন, এডিট করুন এবং এক্সপোর্ট করুন। সবই ব্যক্তিগতভাবে।",
		...
		dialogs: {
			delete: {
				...
				descriptionMultiple: "এটি চিরতরে {count}টি প্রজেক্ট এবং এর সাথে সম্পর্কিত সকল ফাইল মুছে ফেলবে।",
