    ...
    <BasePage title={privacy.title} description={privacy.description}>
      ...
      <section className="flex flex-col gap-3">
        <h2 className="text-2xl font-semibold">
          {privacy.sections.content.title}
        </h2>
      ...
      <section className="flex flex-col gap-3">
        <h2 className="text-2xl font-semibold">
          {privacy.sections.accounts.title}
        </h2>
      ...
      <section className="flex flex-col gap-3">
        <h2 className="text-2xl font-semibold">
          {privacy.sections.transparency.title}
        </h2>
      ...
      <section className="flex flex-col gap-3">
        ...
        <p>
          {privacy.sections.contact.p2.split("{github}")[0]}
          <a
          ...
          {privacy.sections.contact.p2.split("{github}")[1].split("{email}")[0]}
          <a
            href="mailto:oss@procut.app"
            className="text-primary hover:underline"
          >
          ...
          {privacy.sections.contact.p2.split("{email}")[1].split("{x}")[0]}
          <a
            href={social.x}
            target="_blank"
            rel="noopener noreferrer"
      ...
      <p className="text-muted-foreground text-sm">{privacy.lastUpdated}</p>
    </BasePage>
  );
}
