export const editorTranslations = {
	en: {
		...
		sounds: {
			...
			clearAllDescription: "This will permanently remove all {count} saved sounds from your collection. This action cannot be undone.",
	...
	bn: {
		...
		properties: {
			empty: {
				...
				description: "বৈশিষ্ট্য পরিবর্তন করতে টাইমলাইনে একটি এলিমেন্টে ক্লিক করুন",
			},
		},
		text: {
			title: "টেক্সট",
		...
		sounds: {
			...
			commercialFilterActive: "শুধুমাত্র বাণিজ্যিক ব্যবহারের জন্য অনুমোদিত শব্দগুলো দেখানো হচ্ছে",
			...
			clearAllDescription: "এটি আপনার সংগ্রহ থেকে সকল {count}টি সংরক্ষিত শব্দ চিরতরে মুছে ফেলবে। এই কাজটি আর ফিরিয়ে আনা যাবে না।",
