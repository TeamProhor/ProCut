		...
		<div className="flex h-full flex-col">
			<Tabs defaultValue="sound-effects" className="flex h-full flex-col">
				<div className="px-3 pt-4 pb-0">
					<TabsList>
						<TabsTrigger value="sound-effects">{t.editor.sounds.tabs.effects}</TabsTrigger>
						<TabsTrigger value="saved">{t.editor.sounds.tabs.saved}</TabsTrigger>
					</TabsList>
				</div>
				...
				>
					<div className="flex flex-col gap-4">
						...
						{!isLoading && !isSearching && displayedSounds.length === 0 && (
							<div className="text-muted-foreground text-sm">
								{searchQuery ? t.editor.sounds.emptySearch : t.editor.sounds.emptyAvailable}
							</div>
						)}
						{isLoadingMore && (
